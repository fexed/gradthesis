...
for i in range(37, 57):
    if(i not in excluded_subjects):
        ...
        # Salvataggio
        with open("/home/fexed/ML/datasets/ASCERTAIN/splitted/XS" + str(n) + ".pkl", 'wb') as handle:
            pickle.dump(Xs, handle, protocol=pickle.HIGHEST_PROTOCOL)
        with open("/home/fexed/ML/datasets/ASCERTAIN/splitted/yS" + str(n) + ".pkl", 'wb') as handle:
