...
Gli esperimenti sono stati eseguiti su un personal computer montante come sistema operativo Windows 10 in versione developer build 21390.2025 e all'interno della Windows Subsystem for Linux, con supporto alla GPU.\\\\% Specificare hardware?
