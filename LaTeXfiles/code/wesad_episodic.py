...
Xts = pickle.load(open("atasets/WESAD/splitted/Xts.pkl", 'rb'), encoding='latin1')
yts = pickle.load(open("atasets/WESAD/splitted/yts.pkl", 'rb'), encoding='latin1')
...
for S in [("S2", "S3"), ("S4", "S5"), ("S6", "S7"), ("S8", "S9"), ("S10", "S11"), ("S13", "S14"), ("S15", "S16")]:
    ...
    Xa = pickle.load(open("atasets/WESAD/splitted/X" + S[0] + ".pkl", 'rb'), encoding='latin1')
    ya = pickle.load(open("atasets/WESAD/splitted/y" + S[0] + ".pkl", 'rb'), encoding='latin1')
    Xb = pickle.load(open("atasets/WESAD/splitted/X" + S[1] + ".pkl", 'rb'), encoding='latin1')
    yb = pickle.load(open("atasets/WESAD/splitted/y" + S[1] + ".pkl", 'rb'), encoding='latin1')
